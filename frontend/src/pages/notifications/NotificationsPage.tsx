...
export default function NotificationsPage() {
  ...
  useEffect(() => { fetchNotifications(); }, [showAll]);
          ...
          {notifications.map(n => (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  <p style={{ margin: 0, fontSize: 14, color: "#1e293b", fontWeight: n.read ? 400 : 600 }}>
                    {n.message}
                  </p>
              ...
              {!n.read && (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600, fontSize: 12, flexShrink: 0, marginLeft: 16
                  }}
                >
                  Mark as Read
                </button>
