...
export default function RenameColumnModal({
  ...
  const handleSave = async () => {
    ...
    try {
      await apiClient.put(`/projects/${projectId}/boards/${boardId}/columns/${column.id}`, {
        name: name.trim(),
        status,
        ...
        >
          <div>
            ...
            <p style={{ margin: "4px 0 0 0", fontSize: 13, color: "#64748b" }}>
              Update column name, status or WIP limit
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            <div>
              <label style={labelStyle}>
                WIP Limit <span style={{ fontWeight: 400, color: "#94a3b8" }}>(optional)</span>
              </label>
              <input
                type="number"
                min="1"
